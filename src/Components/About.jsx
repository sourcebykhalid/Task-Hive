    ...
    <Reveal>
      <div className=" px-6 md:px-14 pt-5">
        <Accordion open={open === 1}>
          ...
          <AccordionBody className="bg-gradient-to-r from-yellow-100 to-black text-teal-500 p-8 border-b-4 rounded-sm border-black">
        ...
        <Accordion open={open === 2}>
          ...
          <AccordionBody className="bg-gradient-to-r from-yellow-100 to-black text-teal-500 p-8 border-black">
